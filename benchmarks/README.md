...
| `lrrt_mutex_contention_benchmark` | Lightweight API probes during queue/module synchronization or destruction, event, backpressure, and synchronous-copy waits |
