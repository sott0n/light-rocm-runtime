func.func @qwen_decode1_layer(
    ...
    %down_weight: tensor<4864x896xf32>) -> (tensor<1x128xf32>, tensor<1x128xf32>, tensor<1x896xf32>) {
  ...
  %context = linalg.generic {
      indexing_maps = [
        affine_map<(d0, d1) -> (d0, (d1 floordiv 448) * 64 + (d1 mod 64))>,
        affine_map<(d0, d1) -> (d0, d1)>
      ],
      iterator_types = ["parallel", "parallel"]
    }
      ins(%v : tensor<1x128xf32>)
  ...
  return %k, %v, %result : tensor<1x128xf32>, tensor<1x128xf32>, tensor<1x896xf32>
}
