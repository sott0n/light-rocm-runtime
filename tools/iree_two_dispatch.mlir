func.func @two_matmuls(
    %lhs: tensor<2x2xf32>,
    %rhs0: tensor<2x2xf32>,
    %rhs1: tensor<2x2xf32>) -> tensor<2x2xf32> {
  ...
  %init1 = linalg.fill
      ins(%zero : f32)
      outs(%empty1 : tensor<2x2xf32>) -> tensor<2x2xf32>
  %result = linalg.matmul
      ins(%product0, %rhs1 : tensor<2x2xf32>, tensor<2x2xf32>)
      outs(%init1 : tensor<2x2xf32>) -> tensor<2x2xf32>
