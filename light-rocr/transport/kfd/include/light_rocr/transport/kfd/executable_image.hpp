#ifndef LIGHT_ROCR_TRANSPORT_KFD_EXECUTABLE_IMAGE_HPP
#define LIGHT_ROCR_TRANSPORT_KFD_EXECUTABLE_IMAGE_HPP
...
private:
  ...
  materialize_executable_image(const KfdSession &, const runtime::Node &,
...
struct ExecutableImageResult {
  ...
  // A failed materialization may retain an allocation whose cleanup needs to
...
[[nodiscard]] ExecutableImageResult materialize_executable_image(
